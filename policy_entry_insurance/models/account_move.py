...
class AccountMove(models.Model):
    ...
    invoice_type = fields.Selection([('regular_inv','Regular Invoice'),('policy','Policy'),('endors','Endorsement'),('commission_inv','Commission Invoice'),('claim_inv','Claim Invoice')],default='policy',string="Transaction Type")
